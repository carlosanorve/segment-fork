package main.java.com.example.flutter_segment;
 ...
 */
public class AppsflyerIntegrationManual extends Integration<AppsFlyerLib> {
    ...
    public static void setManualMode(Boolean manualMode) {
        Log.d("APPSFLYER", "manuel test null ");
        AppsflyerIntegrationManual.manualMode = manualMode;
    }

    public static void startAppsFlyer(Context context) {
        Log.d("APPSFLYER", "start test null ");
        if (context != null) {
    ...
    public static final Factory FACTORY = new Integration.Factory() {
        ...
        public Integration<AppsFlyerLib> create(ValueMap settings, Analytics analytics) {
            ...
            // AppsFlyerLib.getInstance().setPluginInfo(new PluginInfo(Plugin.SEGMENT,
            // "6.10.3"));
            // afLib.setDebugLog(logger.logLevel != Analytics.LogLevel.NONE);
            ...
            logger.verbose("AppsFlyer.getInstance().start(%s, %s)", application,
            ...
            // Segment React Native integration with AppsFLyer is used, we need to send
            // first launch manually
            if (isReact) {
            ...
            return new AppsflyerIntegrationManual(application, logger, afLib, devKey);
        }
    ...
    public AppsflyerIntegrationManual(Context context, Logger logger, AppsFlyerLib afLib, String devKey) {
    ...
    static class ConversionListener implements AppsFlyerConversionListener {
        ...
        public void onAppOpenAttribution(Map<String, String> attributionData) {
            Log.d("APPSFLYER", "onAppOpenAttribution test ");
        ...
        void trackInstallAttributed(Map<String, ?> attributionData) {
            ...
            // If you are working with networks that don't allow passing user level data to
            // 3rd parties,
